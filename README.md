...
(Note: Replace with your username if different)
Open the script: Load qPCR_Analysis_Pipeline.R in RStudio.
Input Data:
...
Global Bar Plot of Gene Expression

Expression Heatmap
Heatmap with Significance Markers

Volcano Plot
Volcano Plot for Treatment A
